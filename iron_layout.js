...
if (typeof Template !== 'undefined') {                                                                                 // 275
   ...
   *    </footer>                                                                                                      // 290
   */                                                                                                                  // 291
  Template.registerHelper('yield', new Template('yield', function () {                                                       // 292
   ...
   *                                                                                                                   // 342
   */                                                                                                                  // 343
  Template.registerHelper('contentFor', new Template('contentFor', function () {                                             // 344
   ...
   *    {{/if}}                                                                                                        // 387
   */                                                                                                                  // 388
  Template.registerHelper('hasRegion', function (region) {                                                                   // 389
   ...
   *  {{/Layout}}                                                                                                      // 411
   */                                                                                                                  // 412
  Template.registerHelper('Layout', new Template('layout', function () {                                                     // 413
