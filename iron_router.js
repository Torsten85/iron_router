 ...
 * document.body.                                                                                                 // 14
 */                                                                                                               // 15
Template.registerHelper('Router', new Blaze.Template('Router', function () {                                            // 16
 ...
 */                                                                                                               // 23
Template.registerHelper('pathFor', function (options) {                                                                 // 24
  var routeName;                                                                                                  // 25
                                                                                                                  // 26
 ...
 */                                                                                                               // 65
Template.registerHelper('urlFor', function (options) {                                                                  // 66
  var routeName;                                                                                                  // 67
                                                                                                                  // 68
 ...
 *   {{/linkTo}}                                                                                                  // 109
 */                                                                                                               // 110
Template.registerHelper('linkTo', new Blaze.Template('linkTo', function () {                                            // 111
  var self = this;                                                                                                // 112
